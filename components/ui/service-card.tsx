            ...
            >
                ...
                >
                    ...
                    <p className={cn(
                        ...
                        <span 
                            className="absolute inset-0 -z-10 rounded-4xl backdrop-blur-xl bg-linear-to-br from-background/10 via-background/5 to-background/10 border border-border/20"
                            style={{
                                borderRadius: '2rem',
