...
export default function About() {
  return (
    <section className="w-full bg-background py-16 md:py-24 lg:py-32">
      <AnimatedDottedBorder className="container mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-6xl max-w-[90vw] text-neutral-600 rounded-lg p-10 hover:scale-105 transition-all duration-300">
          ...
          <div className="flex flex-col gap-4 items-center md:items-start">
            <div className="flex flex-col gap-2 items-center md:items-start w-full">
              <div className="flex flex-row flex-wrap items-center justify-center md:justify-start gap-4">
                <h2 className="font-inter text-sm sm:text-md md:text-lg font-medium text-foreground">
                  Rafe Loveday
                </h2>
                <div className="flex flex-row items-center gap-2 opacity-85">
              ...
              <div className="font-roboto text-xxs sm:text-xs md:text-xs inline-flex items-center px-4 py-2 rounded-full bg-linear-to-r from-blue-500 from- via-blue-900 via-100% w-fit select-none text-foreground text-center">
