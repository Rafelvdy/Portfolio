        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center ">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-row items-center justify-start gap-2 opacity-85">
            ...
            <div className="flex flex-col gap-2 font-roboto text-sm sm:text-md md:text-md text-foreground opacity-75 font-semibold">
